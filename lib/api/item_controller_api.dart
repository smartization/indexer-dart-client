...
class ItemControllerApi {
  ...
  ///
  /// 
  Future<List<ItemDTO>> get1() async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return
        (apiClient.deserialize(response.body, 'List<ItemDTO>') as List).map((item) => item as ItemDTO).toList();
    } else {
      return null;
    }
  }
  ...
  Future<ItemDTO> getById(int item id to resolve) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'ItemDTO') as ItemDTO ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<ItemDTO> post1({ ItemDTO body }) async {
